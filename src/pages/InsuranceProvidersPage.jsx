...
function InsuranceProvidersPage() {
  ...
  const insuranceProviders = getProviders('insurance');
  ...
  }, [insuranceProviders, searchQuery, selectedCategory, connectedProviderIds]);

  const categories = [
    { id: 'all', name: 'All Insurance', count: insuranceProviders.length },
    { id: 'health_insurance', name: 'Health', count: insuranceProviders.filter(p => p.category === 'health_insurance').length },
    { id: 'dental', name: 'Dental', count: insuranceProviders.filter(p => p.category === 'dental').length },
    { id: 'vision', name: 'Vision', count: insuranceProviders.filter(p => p.category === 'vision').length },
  ];
      ...
      <div className="pt-safe-top px-4">
        ...
        <div className="py-6">
          ...
          <p className="text-gray-600 font-medium mb-6">
            Connect your insurance to access claims, coverage, and benefits information.
          </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-700">
                Claims history, coverage details, deductibles, and eligibility information. 
                We never access payment methods or make changes to your account.
              </p>
            </div>
          </div>
        </div>
          ...
          {contextLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-4">
                {searchQuery 
                  ? `No insurance providers match "${searchQuery}"`
