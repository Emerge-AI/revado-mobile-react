    ...
    <AnimatePresence>
      ...
      >
        <div className="max-w-lg mx-auto">
          <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-xl p-4 shadow-lg">
            <div className="flex items-start gap-3">
                ...
                <div className="space-y-2 text-xs text-orange-600 dark:text-orange-400">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p>Run <code className="bg-orange-100 dark:bg-orange-900/50 px-1 rounded">./setup-https.sh</code> then access via <code className="bg-orange-100 dark:bg-orange-900/50 px-1 rounded">https://localhost:5173</code></p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p>Use ngrok: <code className="bg-orange-100 dark:bg-orange-900/50 px-1 rounded">ngrok http 5173</code></p>
                    </div>
                  </div>
                </div>
              </div>
              <button
                ...
                className="flex-shrink-0 p-1 rounded-lg hover:bg-orange-100 dark:hover:bg-orange-800/50 transition-colors"
              >
